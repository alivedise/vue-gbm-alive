...
Object.entries(object).forEach(([k, v]) => {
  object[k] = v
    ...
    .replace(/アンチビームシールド/ig, '反光束盾牌')
    .replace(/mmライフル/ig, 'mm步槍')
    .replace(/ダブル・/ig, '雙管')
    .replace(/バスターシールド/ig, '破壞盾')
    .replace(/シェンロン・?/ig, '神龍')
    .replace(/シールド・ブースター/ig, '盾牌推進器')
    .replace(/バースト/ig, '爆發')
    .replace(/ミサイル・ランチャー/ig, '飛彈發射器')
    .replace(/ミサイル・?ポッド/ig, '飛彈莢艙')
    .replace(/ミサイル/ig, '導彈')
    .replace(/ランチャー/ig, '發射器')
    .replace(/アームズ/ig, '武裝')
    .replace(/ビームソード/ig, '光束劍')
    ...
    .replace(/^脚部/ig, '腳部')
    .replace(/ビーム・マシンガン/ig, '光束機槍')
    .replace(/ヴァジュラ/ig, '金剛杵式')
    .replace(/ビーム・?ガン/ig, '光束加農砲')
    .replace(/致死攻撃を耐える/ig, '免死')
    .replace(/格鬥威力が/ig, '格鬥攻擊')
    .replace(/・/ig, '·')
    .replace(/バーニアの消費量が/ig, '推進器消耗量')
    .replace(/のリロード/ig, '裝填')
    .replace(/パーツの/ig, '零件')
    .replace(/近接武器の/ig, '格鬥武器')
    .replace(/射擊武器の/ig, '射擊武器')
    .replace(/ガンモード/ig, '槍模式')
    .replace(/ソードモード/ig, '劍模式')
    .replace(/モード/ig, '模式')
    .replace(/バスターソード/ig, '巨劍')
    .replace(/クレイ・バズーカ/ig, '黏著彈火箭砲')
    ...
    .replace(/ユニコーン/ig, '獨角獸')
    .replace(/インフィニット/ig, '無限')
    .replace(/ハイ・/ig, '超絕')
    .replace(/ハイネ/ig, '海涅')
    .replace(/レーザー/ig, '雷射')
    .replace(/［アリオス］/ig, '［墮天使］')
    .replace(/ジャスティス/ig, '正義')
    .replace(/［アストレア/ig, '［正義女神')
    .replace(/［フルアーマー/ig, '［全裝甲')
    .replace(/［デスティニー/ig, '［命運')
    .replace(/ライフルモード/ig, '步槍模式')
    .replace(/インパルス/ig, '脈衝')
    .replace(/メガ・?/ig, 'MEGA')
    .replace(/ブレストビーム/ig, '胸部光束')
    .replace(/ブレスト/ig, '胸部')
    ...
    .replace(/ミラージュコロイド/ig, '幻象粒子')
    .replace(/ロケット砲/ig, '火箭砲')
    .replace(/バルカン/ig, '火神砲')
    .replace(/敵敵/ig, '敵');
});
